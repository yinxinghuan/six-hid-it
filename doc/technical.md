...
- 猫爪：同一 DOM 前腿根据答案槽位切换左右侧，宽 400px 且锚定在画面外 420px；白爪尖进入桌面，深棕前腿根部始终留在画面外，整体层级位于杯子之后。
- 杯子物理：前两次只用贴桌横移 5/11px 和 2°/4° 底部偏转；第三次依序执行蓄势、爪垫接触、离桌翻滚、邻杯碰撞、第一次落桌和回弹。静止与揭晓 SVG 均移除内置椭圆投影，避免旋转时暴露假阴影。
